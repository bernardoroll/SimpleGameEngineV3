package com.book.simplegameengine_v3;
...
public class SGSprite {
	...
	private HashMap<String, SGAnimation> mAnimations = new HashMap<String, SGAnimation>();
	...
	public SGAnimation getAnimation(String animationName) {
		...
		if(animation == null) {
			...
			stringBuilder.append("' nao possui uma animacao de nome '");
